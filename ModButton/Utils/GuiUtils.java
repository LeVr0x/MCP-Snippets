...
public class GuiUtils {
    ...
    public static void drawChromaString(String string, int x, int y, boolean shadow)
    {
        ...
        for (char textChar : string.toCharArray())
        {
            ...
            ((FontRenderer) mc.fontRendererObj).drawString(tmp, xTmp, y, i, shadow);
            xTmp += ((FontRenderer) mc.fontRendererObj).getCharWidth(textChar);
        }
    }
    ...
    public static ResourceLocation getHeadLocation(String displayName) {
        ResourceLocation playerSkin = (ResourceLocation)playerSkins.getOrDefault(displayName, new ResourceLocation("Client/player/heads/" + displayName + ".png"));
        if (!playerSkins.containsKey(displayName)) {
            ThreadDownloadImageData skinData = new ThreadDownloadImageData(null, "https://minotar.net/helm/" + displayName + "/32.png", new ResourceLocation("Client/player/heads/steve.png"), null);
    ...
    public static void drawScaledLogo(double x, double y, int size, String clientSource, String logoName) {
        GL11.glPushMatrix();
    ...
    public static void drawTexture(final ResourceLocation resourceLocation, final double x, final double y, final double width, final double height) {
        GL11.glPushMatrix();
        final double size = width / 2.0f;
        GL11.glEnable(3042);
        GL11.glEnable(3553);
        GL11.glEnable(2848);
    ...
    public static void drawSmoothRoundedRect(double x, double y, double x1, double y1, float radius, int color) {
        glPushAttrib(0);
    ...
    public static void drawRoundedOutline(double x, double y, double x1, double y1, float radius,float lineWidth, int color) {
        glPushAttrib(0);
        glScaled(0.5D, 0.5D, 0.5D);
        x *= 2.0D;
        y *= 2.0D;
