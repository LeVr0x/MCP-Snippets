...
public class MinecraftFontRenderer extends CFont {
    ...
    public int drawStringWithShadow(String text, double x2, double y, int color) {

        float shadowWidth = this.drawString(text, x2 + 0.9f, (double) y + 0.5f, color, true, 8.3f);

        return (int) Math.max(shadowWidth, this.drawString(text, x2, y, color, false, 8.3f));
    }
